...
const SOUND_FLOOR_NORMAL := preload("res://assets/audio/sfx/environment/normal_floor_start.ogg")
const SOUND_FLOOR_BOSS := preload("res://assets/audio/sfx/environment/boss_floor_start.ogg")
const SOUND_FLOOR_ITEM := preload("res://assets/audio/sfx/environment/item_floor_start.ogg")
...
const SOUND_ITEM_MIST := preload("res://assets/audio/sfx/environment/item_room_mist_door.ogg")
